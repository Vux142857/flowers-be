...
const suggestion_entity_1 = require("./suggestion.entity");
...
exports.SuggestionsModule = SuggestionsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [suggestions_service_1.SuggestionService],
        imports: [typeorm_1.TypeOrmModule.forFeature([suggestion_entity_1.Suggestion])],
        exports: [suggestions_service_1.SuggestionService],
    })
], SuggestionsModule);
