...
const StatusOrder_enum_1 = require("../../../orders/enum/StatusOrder.enum");
class PaginationQueryDto {
    constructor() {
        this.limit = 10;
        this.page = 1;
        this.status = statusType_enum_1.StatusType.ACTIVE;
...
__decorate([
    ...
    __metadata("design:type", String)
], PaginationQueryDto.prototype, "statusOrder", void 0);
